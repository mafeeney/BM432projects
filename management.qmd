...
## Before you begin your experimental work, you should:
...
☐ Have already selected a reference manager, and begun to input records for the papers that you are reading/likely to cite

☐ Have chosen a format for keeping a lab notebook, to record your experiments and daily progress
...
-   You may find it helpful to use project planning tools such as [Trello](link), [Asana](), or similar tools that help to manage tasks/track completion/etc.
...
Remember, your project performance mark contributes to your overall mark for the BM432 module. This includes your ability to search the literature independently, meet deadlines, come prepared to meetings, etc.
